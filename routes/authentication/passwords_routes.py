from schemas.authentication.passwords_schema import PasswordRead, PasswordCreate, PasswordUpdate, PasswordDeactivate
from controllers.authentication.passwords_controller import PasswordsController
from controllers.authentication.users_controller import UsersController
from fastapi import APIRouter, Depends, HTTPException
from sqlmodel.ext.asyncio.session import AsyncSession
from configs.database import get_session
from modules.auth import auth_bearer
